   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel.font = [UIFont boldSystemFontOfSize:22.0f];
...
#define kButtonBottomOffset 10.0f
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:0/255.0 green:122/255.0 blue:252/255.0 alpha:1]] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor redColor]] forState:UIControlStateNormal];
    ...
    comfirmTitle:(NSString *)comfirmTitle
{
    if (self = [super init]) {
        ...
        CGRect comfirmBtnFrame;
        
            comfirmBtnFrame = CGRectMake(3, kAlertHeight - kButtonBottomOffset - kButtonHeight, kSingleButtonWidth * 3/2, kButtonHeight);
            self.comfirmBtn = [UIButton buttonWithType:UIButtonTypeCustom];
            self.comfirmBtn.frame = comfirmBtnFrame;
            
 
        [self.comfirmBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:0/255.0 green:122/255.0 blue:252/255.0 alpha:1]] forState:UIControlStateNormal];
        
        [self.comfirmBtn setTitle:comfirmTitle forState:UIControlStateNormal];
        
        self.comfirmBtn.titleLabel.font =  [UIFont boldSystemFontOfSize:18];
        
        [self.comfirmBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        
        [self.comfirmBtn addTarget:self action:@selector(comfirmBtnClicked:) forControlEvents:UIControlEventTouchUpInside];
        
        self.comfirmBtn.layer.masksToBounds = YES;
        
        self.comfirmBtn.layer.cornerRadius = 3.0;
...
- (void)comfirmBtnClicked:(id)sender
{
    _leftLeave = NO;
    [self dismissAlert];
