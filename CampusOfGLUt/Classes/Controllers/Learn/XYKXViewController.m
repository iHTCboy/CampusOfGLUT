...
@interface XYKXViewController ()<FocusImageViewDelegate, UITableViewDataSource,UITableViewDelegate>
...
@implementation XYKXViewController
...
- (void)loadinagMoreNews:(UIButton *)moreBtn
{
    ...
    if (self.morePage > 0)
    {
        ...
        [self.fetchNewsTool getNewsListDataWithClassName:@"校园快讯" page:(int)self.morePage success:^(NSArray *fetchNewsArray, int nextPage)
         {
...
{
    [self.fetchNewsTool getNewsListDataWithClassName:@"校园快讯" page:0 success:^(NSArray *fetchNewsArray, int nextPage)
     {
