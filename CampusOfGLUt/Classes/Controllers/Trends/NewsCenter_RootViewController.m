//
//  NewsCenter_RootViewController.m
//  CampusOfGLUT
//
...
@interface NewsCenter_RootViewController ()<FocusImageViewDelegate, UITableViewDataSource,UITableViewDelegate>
...
@implementation NewsCenter_RootViewController
